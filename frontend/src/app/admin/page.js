    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-slate-400 text-sm font-medium animate-pulse">Loading console...</p>
        </div>
      </div>
    );
  }
...
=======
            <Badge variant="outline" className="badge-rose text-xs">System Console</Badge>
            <Badge variant="outline" className="badge-violet font-mono text-xs">{user.admin_level || 'L1'}</Badge>
>>>>>>> dfcb8b4dcbd245453f1448c935a8ac364f27767e
          </div>
                  ...
                  <motion.div key={i} whileHover={{ y: -4 }} className="h-full">
                    <Card className="glass-card h-full border-white/5 bg-white/5 overflow-hidden relative group">
                      ...
                      <CardContent className="p-4">
                        ...
                        <p className="text-lg font-bold text-white tracking-tight truncate font-heading uppercase">
                          {stat.value}
                        </p>
                      </CardContent>
                    </Card>
