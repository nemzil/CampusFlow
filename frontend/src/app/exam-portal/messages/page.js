...
import { getConversations, sendMessage, markConversationAsRead, markConversationAsUnread, archiveConversation, muteConversation, deleteConversation, clearChat } from '@/lib/api';
...
export default function MessagesPage() {
  ...
  const showNotification = (title, body, conversationId) => {
    if ('Notification' in window && Notification.permission === 'granted') {
      // Don't show notification if user is on the page and it's visible
      if (document.hidden) {
